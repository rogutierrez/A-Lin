...
Ejemplo (1): Sea la base $B=\{ (-1,0,0),(0,1,0),(1,0,-3) \}$ de $\mathbb{R}^3$, las coordenadas del vector $(1,2,3)$ respecto de esta base son:
...
Ejemplo (2): Sean las bases $B_1=\{(1,0),(1,3\}$ y $B_2=\{(0,1),(1,1\}$.
